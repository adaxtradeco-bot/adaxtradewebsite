...
لطفا هر کاری ازت میخوام اول به کارهای کوچکتر تقسیم کن دسته بندی و اولویت بندی کن و بعد لیستت رو اماده کن و بعد یکی یکی انجامشون بده و حتی اگر لازمه در جند مرخله انجام بده که دقیق و درست و کامل انجام بشه 

در مواردی که قراره در CORE سیستم دست ببری یا تغییرات گسترده روی تعداد زیاد از قابلیت ها یا فایل ها بدی و یا با ساده سازی یا حذف یک قابلیت مشکل رو گیدا کنی حتما قبلا تاییده بگیر
