...
export default function TrustBadgesSection({ data, style }: TrustBadgesSectionProps) {
  return (
    <div className={`py-8 border-t border-white/5 border-b ${style?.backgroundColor || 'bg-slate-900'} ${style?.textColor || 'text-white'} ${style?.padding || ''}`}>
