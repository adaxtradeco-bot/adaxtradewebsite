      ...
      data: {
        ...
        events: [
          ...
          },
          {
            ...
            infographicType: 'flow',
            infographicData: {
              nodes: [
                { label: 'Parent Completes', type: 'start' },
                { label: 'Data Mapping', type: 'process' },
                { label: 'Child Starts', type: 'decision' },
                { label: 'Linked Audit', type: 'end' },
              ],
            },
            exampleLabel: 'eg.',
          ...
          },
          {
            ...
            infographicData: {
              steps: [
                { title: 'Schedule Set', description: 'Daily/Weekly/Monthly', time: 'Config', status: 'completed' },
                { title: 'Calendar Logic', description: 'Skip weekends & holidays', time: 'Auto', status: 'completed' },
                { title: 'Auto-Start', description: 'Tasks assigned to roles', time: 'Trigger', status: 'active' },
                { title: 'No Dev Required', description: 'Visual configuration', time: 'Platform', status: 'pending' },
              ],
            },
            exampleLabel: 'eg.',
          ...
          },
          {
            ...
            infographicData: {
              ...
              steps: [
                { num: '1', label: 'REST Call', badge: 'POST/GET/PUT', type: 'action' },
                { num: '2', label: 'Payload', badge: 'Filtered Fields', type: 'conditional' },
                { num: '3', label: 'Response', badge: 'Map to Fields', type: 'ai' },
                { num: '4', label: 'Auth & Retry', badge: 'Configurable', type: 'action' },
              ],
            },
            exampleLabel: 'eg.',
          ...
          },
          {
            ...
            infographicType: 'sla-bars',
            infographicData: {
              title: 'Escalation Levels',
              bars: [
                { label: 'Level 0 - Reminder', value: 100, status: 'green' },
                { label: 'Level 1 - Reassign', value: 85, status: 'green' },
                { label: 'Level 2 - Escalate', value: 60, status: 'amber' },
                { label: 'Level 3 - Compliance', value: 30, status: 'red' },
              ],
            },
            exampleLabel: 'eg.',
