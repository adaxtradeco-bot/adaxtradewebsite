  ...
  'governance-grid': {
    ...
    'cards[].infographic.type': {
      ...
      allowedValues: [
        ...
        { value: 'exception-alert', label: 'Exception Alert - Detailed alert with badge' },
        { value: 'role-levels', label: 'Role Levels - Role hierarchy with descriptions' },
      ],
      examples: ['audit', 'stats', 'exception-alert', 'role-levels'],
      note: 'Each type requires specific data structure',
    },
    'cards[].infographic.data.statusColor': {
      label: 'Status Color (for exception-alert)',
      description: 'Color for status text',
      allowedValues: [
        { value: 'red', label: 'Red - Critical/Error' },
        { value: 'amber', label: 'Amber - Warning' },
      ],
      examples: ['red', 'amber'],
      note: 'Only used with exception-alert type',
    },
    'cards[].infographic.data.badgeColor': {
      label: 'Badge Color (for exception-alert)',
      ...
      examples: ['amber', 'green', 'cyan'],
      note: 'Only used with exception-alert type',
    },
    'cards[].infographic.data.roles[].color': {
      label: 'Role Color (for role-levels)',
      description: 'Color for role item',
      allowedValues: [
      ...
      examples: ['indigo', 'cyan', 'green'],
      note: 'Only used with role-levels type',
    },
  ...
  'analytics-bento-grid': {
    'cards[].infographic.type': {
      ...
      allowedValues: [
        ...
        { value: 'performance', label: 'Performance - Progress bars with auto-color by score' },
        { value: 'performance-bars', label: 'Performance Bars - Custom colored progress bars' },
      ...
      examples: ['kpi', 'performance-bars', 'status-list'],
      note: 'Each type requires specific data structure',
    },
    'cards[].infographic.data.performers[].color': {
      label: 'Bar Color (for performance-bars type)',
      description: 'Color for performance bar',
      allowedValues: [
        { value: 'green', label: 'Green' },
        { value: 'cyan', label: 'Cyan' },
        { value: 'amber', label: 'Amber' },
      ...
      examples: ['green', 'cyan', 'amber'],
      note: 'Only used with performance-bars type. Regular performance type auto-colors based on score',
    },
