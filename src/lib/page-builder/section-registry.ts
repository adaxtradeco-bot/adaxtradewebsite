...
export const SECTION_TEMPLATES: SectionTemplate[] = [
  ...
  // ── Reports & Analytics sections ──────────────────────────────────────
  {
    ...
    type: 'reports-hero',
    category: SECTION_CATEGORIES.HEADERS,
    description: 'Full-screen hero for Reports & Analytics page with animated orbs, media frame, and dashboard preview',
    icon: '📊',
    defaultData: {
      id: '', type: 'reports-hero', order: 0,
      data: {
        ...
        primaryButtonText: 'Explore demo', primaryButtonHref: '#',
        secondaryButtonText: 'Request a demo', secondaryButtonHref: '#',
        mediaUrl: '', mediaType: 'default', mediaObjectFit: 'contain',
        kpis: [
        ...
        accentColor: '#6366f1', accentColor2: '#818cf8', cyanColor: '#06b6d4',
      },
      style: { backgroundColor: 'bg-[#080810]', textColor: 'text-white', padding: 'py-0' },
    },
    configSchema: {},
  },
  {
    ...
    icon: '⚡',
    defaultData: {
      id: '', type: 'reports-what-you-can-build', order: 0,
      data: {
        ...
        accentColor: '#6366f1', accentColor2: '#818cf8',
      },
      style: { backgroundColor: 'bg-white dark:bg-[#080810]', textColor: 'text-slate-900 dark:text-white', padding: 'py-20' },
    },
    configSchema: {},
  },
  {
    ...
    category: SECTION_CATEGORIES.CONTENT,
    description: 'Two-column: text + interactive chart mock (replaceable with real screenshot)',
    icon: '📈',
    defaultData: {
      id: '', type: 'reports-chart-builder', order: 0,
      data: {
        ...
        chartTypes: ['Bar', 'Line', 'Area', 'Pie', 'Scatter', 'Heatmap', 'Combo', 'KPI Card', 'Gauge', 'Funnel'],
        ...
        mediaUrl: '', mediaObjectFit: 'contain',
        accentColor: '#6366f1', accentColor2: '#818cf8',
      },
      style: { backgroundColor: 'bg-slate-50 dark:bg-[#0e0e1a]', textColor: 'text-slate-900 dark:text-white', padding: 'py-20' },
    },
    configSchema: {},
  },
  {
    ...
    type: 'reports-table',
    category: SECTION_CATEGORIES.CONTENT,
    description: 'Text + interactive data table mock (replaceable with real screenshot)',
    icon: '⊞',
    defaultData: {
      id: '', type: 'reports-table', order: 0,
      data: {
  ...
  },
  {
    ...
    icon: '▦',
    defaultData: {
      id: '', type: 'reports-kanban', order: 0,
      data: {
        ...
        columns: [
          ...
          { title: 'In Progress', count: 2, cards: [
  ...
  },
  {
    ...
    icon: '✦',
    defaultData: {
      id: '', type: 'reports-ai-insights', order: 0,
      data: {
      ...
      style: { backgroundColor: 'bg-[#1e1b4b]', textColor: 'text-white', padding: 'py-20' },
    },
    configSchema: {},
  },
  {
    ...
    category: SECTION_CATEGORIES.CONTENT,
    description: 'Grid of data connector cards — internal, databases, APIs, files',
    icon: '🔌',
    defaultData: {
      id: '', type: 'reports-data-sources', order: 0,
      data: {
  ...
  },
  {
    ...
    defaultData: {
      ...
      data: {
        ...
        wideBadges: [
          { text: 'Forms & Apps', colorClass: 'indigo' }, { text: 'Workflow engine', colorClass: 'cyan' },
          { text: 'SLA tracking', colorClass: 'violet' }, { text: 'Script Manager', colorClass: 'green' },
          { text: 'AI insights', colorClass: 'indigo' }, { text: 'Communication records', colorClass: 'cyan' },
          { text: 'Customer portals', colorClass: 'violet' }, { text: 'Embedded views', colorClass: 'green' },
        ],
        accentColor: '#6366f1', accentColor2: '#818cf8',
      },
      style: { backgroundColor: 'bg-white dark:bg-[#080810]', textColor: 'text-slate-900 dark:text-white', padding: 'py-20' },
  ...
  },
  {
    ...
    icon: '🔗',
    defaultData: {
      id: '', type: 'reports-integration', order: 0,
      data: {
        ...
        chips: [
          { icon: '⚡', text: 'Forms & Apps' }, { icon: '⚙', text: 'Workflow engine' },
          { icon: '📋', text: 'SLA tracking' }, { icon: '🤖', text: 'Script Manager' },
          { icon: '💬', text: 'Communication records' }, { icon: '✦', text: 'AI insights' },
          { icon: '👥', text: 'Customer portals' }, { icon: '🔗', text: 'Embedded views' },
        ],
        accentColor: '#6366f1', accentColor2: '#818cf8',
      },
      style: { backgroundColor: 'bg-slate-50 dark:bg-[#0e0e1a]', textColor: 'text-slate-900 dark:text-white', padding: 'py-20' },
